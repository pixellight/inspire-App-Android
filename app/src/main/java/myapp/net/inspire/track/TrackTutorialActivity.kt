package myapp.net.inspire.track
 ...
 */
class TrackTutorialActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layouts = intArrayOf(R.layout.onboarding_track_one, R.layout.onboarding_track_two,
                R.layout.onboarding_track_three, R.layout.onboarding_track_four, R.layout.onboarding_track_five,
                R.layout.onboarding_track_six, R.layout.onboarding_track_seven)
        addBottomDots(0)
    ...
    private fun launchHomeScreen() {
        Repository().setIsFirstTimeTrack(this, false)
