 ...
 */
class InspirePlusTutorialActivity :AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layouts = intArrayOf(R.layout.onboarding_one, R.layout.onboarding_two, R.layout.onboarding_three, R.layout.onboarding_four, R.layout.onboarding_five)
        addBottomDots(0)
